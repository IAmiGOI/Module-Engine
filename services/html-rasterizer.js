 ...
 */
export function registerHtmlRasterizerService(servicesBus, { rasterizeToImage = defaultRasterizeToImage } = {}) {
    async function rasterize(params) {
        ...
        const svgString = buildForeignObjectSvg({ html: params?.html, width: logicalWidth, height: logicalHeight, css: params?.css, scale });
