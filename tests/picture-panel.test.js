...
// `isHttpUrl`/`classifyDrop` unit tests moved to tests/drop-classify.test.js
// (ROADMAP.md 5.44) — the functions themselves moved to
// libraries/shared/drop-classify.js when the map module became a second
// real consumer. `handleDrop()` below still exercises classifyDrop
// end-to-end through this Core's own DOM-event wiring.
