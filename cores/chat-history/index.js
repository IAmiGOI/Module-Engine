 ...
 * узнать `mesid` своих собственных сообщений вообще. `mesids` (точечное
 * чтение по конкретным id, игнорируя `limit`) — тот же прозрачный проброс,
 * см. doc-comment `readChat()` в Сервисе.
 *
